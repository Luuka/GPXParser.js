...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector("#demogpx").addEventListener('click', function(e){
        e.preventDefault();
        startDemo(demoGPX);
    });
    ...
    document.querySelector(".demo form").addEventListener('submit', function(e){
        ...
        reader.onload = function(){
            startDemo(reader.result);
        }
        reader.readAsText(file);
    });
});

function startDemo(gpxstr) {
    gpx = new gpxParser();
    gpx.parse(gpxstr);
