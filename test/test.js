...
describe('GPX parser', function() {
    ...
    it('should parse tracks', function(){
        ...
        assert.equal(64.16000000000001, track.elevation.neg);
        assert.equal(14.08843902439025, track.elevation.avg);
        ...
        track.points.forEach(function(pt){
            ...
            if(!firstPt) { // the first point intentionally lacks elevation data
